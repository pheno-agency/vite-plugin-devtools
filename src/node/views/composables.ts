...
export const state = useObjectStorage<DevToolsFrameState>('__devtools-frame-state__', {
  width: 80,
  height: 60,
  top: 0,
  left: 50,
...
export function useIframe(clientUrl: string, onLoad: () => void) {
  ...
  function getIframe() {
    ...
    iframe.value.id = 'devtools-iframe'
...
export function useDevtools(): Ref<{iframeSrc: string, icon: string}> {
