...
// ---- screen ----
const topVarName = '--vite-plugin-devtools-safe-area-top'
const rightVarName = '--vite-plugin-devtools-devtools-safe-area-right'
const bottomVarName = '--vite-plugin-devtools-safe-area-bottom'
const leftVarName = '--vite-plugin-devtools-safe-area-left'
